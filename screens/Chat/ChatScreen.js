    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={styles.headerContainerStyle}>
                <Text style={{ ...Fonts.black20Bold, marginHorizontal: Sizes.fixPadding * 2.0, }}>Chats</Text>
            </View>
            {doctors()}
        </SafeAreaView>
    )
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <View style={{ flex: 1, marginLeft: Sizes.fixPadding }}>
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text numberOfLines={1} style={{ ...Fonts.black16Bold }}>{item.name}</Text>
                                        {item.isActive == true ? <View style={styles.activeIndicatorStyle} /> : null}
                                    </View>
                                    <Text numberOfLines={1} style={{ ...Fonts.gray14Regular }}>{item.message}</Text>
                                </View>
                            </View>
